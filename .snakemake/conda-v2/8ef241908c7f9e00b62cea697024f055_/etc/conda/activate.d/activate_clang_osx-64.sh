...
if [ "${CONDA_BUILD:-0}" = "1" ]; then
  CFLAGS_USED="-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -isystem ${PREFIX}/include -fdebug-prefix-map=${SRC_DIR}=/usr/local/src/conda/${PKG_NAME}-${PKG_VERSION} -fdebug-prefix-map=${PREFIX}=/usr/local/src/conda-prefix"
  DEBUG_CFLAGS_USED="-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -Og -g -Wall -Wextra -isystem ${PREFIX}/include -fdebug-prefix-map=${SRC_DIR}=/usr/local/src/conda/${PKG_NAME}-${PKG_VERSION} -fdebug-prefix-map=${PREFIX}=/usr/local/src/conda-prefix"
  ...
  CFLAGS_USED="-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -isystem ${CONDA_PREFIX}/include"
  DEBUG_CFLAGS_USED="-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fstack-protector-strong -O2 -pipe -Og -g -Wall -Wextra -isystem ${CONDA_PREFIX}/include"
...
_tc_activation \
  ...
  "CLANG,${CLANG:-x86_64-apple-darwin13.4.0-clang}" \
  "CC,${CC:-x86_64-apple-darwin13.4.0-clang}" \
  "OBJC,${OBJC:-x86_64-apple-darwin13.4.0-clang}" \
  "CPP,${CPP:-x86_64-apple-darwin13.4.0-clang-cpp}" \
  ...
  "CPP_FOR_BUILD,${CONDA_PREFIX}/bin/x86_64-apple-darwin13.4.0-clang-cpp" \
